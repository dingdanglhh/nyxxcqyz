...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            String result = "0";//1为成功
            try {
                String path = "http://"+getString(R.string.ip)+":8080/zhccnx/nx/login.action?userId="+mEmail+"&password="+mPassword;
                result = HttpRequest.getHttpURL(path,"GET");
            } catch (Exception e) {
                e.printStackTrace();
            }
